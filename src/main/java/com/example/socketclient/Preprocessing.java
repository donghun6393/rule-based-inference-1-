...
public class Preprocessing
{
    ...
    private void fillStandardizationMatrixes(){
        ...
        std = new float[128][9];
        int i;
//        File meanFile = new File("meanMatrix");
//        File stdFile = new File("stdMatrix");
        try(InputStream meanInputStream = new FileInputStream("/Users/kd639/OneDrive/바탕 화면/rule-based-inference (1)/src/main/resources/meanMatrix");
            InputStream stdInputStream = new FileInputStream("/Users/kd639/OneDrive/바탕 화면/rule-based-inference (1)/src/main/resources/stdMatrix");
